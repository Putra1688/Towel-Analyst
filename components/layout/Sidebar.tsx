      ...
      <div className="p-8 pb-4">
        <div className="flex items-center gap-3 mb-10">
          ...
          <h1 className="text-lg font-bold tracking-tight text-white leading-tight uppercase">
            Towell <span className="text-gold-600 block text-xs tracking-[.4em]">Analyst</span>
          </h1>
        </div>

        <nav className="space-y-2">
          <p className="text-[10px] font-black uppercase tracking-[.4em] text-zinc-600 mb-4 px-4">Menu Utama</p>
          {links.map((link) => {
